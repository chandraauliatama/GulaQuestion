<nav class="bg-white border-green-200 border-b py-2.5 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <a href="{{ route('home') }}" class="flex items-center">
            <img src="{{ asset('images/logo.png') }}" class="h-6 mr-3 sm:h-9" alt="GulaQuestion Logo" />
        ...
        <div class="flex items-center lg:order-2">
            @guest
                ...
                <a href="{{ route('login') }}"
                    class="text-white bg-[#79c39b] hover:bg-[#20ba67] focus:ring-4 focus:ring-green-400 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-green-500 dark:hover:bg-green-500 focus:outline-none dark:focus:ring-green-800">Login</a>
            @endguest
            @auth
        ...
        <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0" id="navMenu">
                ...
                @auth
                    <hr class="lg:hidden my-4 mx-auto w-48 h-1 bg-gray-100 rounded border-0 md:my-10 dark:bg-gray-700">
                    <li class="lg:hidden">
