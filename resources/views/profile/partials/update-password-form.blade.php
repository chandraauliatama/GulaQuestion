<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">Pastikan akunmu menggunakan password yang aman dan panjang untuk membuat
            akunmu tetap aman.</p>
    </header>
        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'password-updated')
                <p x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 2000)"
                    class="text-sm text-green-600 mt-2">Password Berhasil Diubah</p>
            @endif
        </div>
    </form>
</section>
